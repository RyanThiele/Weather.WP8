...
Namespace Services
    ...
    Public Class WeatherService
        ...
        Public Function GetWeatherByDay(point As Point, startDate As Date, numberOfDays As Integer, format As NoaaWeatherFormats, token As CancellationToken) As Object Implements IWeatherService.GetWeatherByDay
